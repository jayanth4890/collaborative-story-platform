    ...
    <div className="max-w-7xl mx-auto space-y-10 animate-fade-in pb-16">
      ...
      <div className="space-y-6">
        ...
        {displayStories.length > 0 ? (
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-3xl p-16 text-center max-w-lg mx-auto">
            {activeTab === 'bookmarks' ? (
              <>
                <BookMarked className="w-10 h-10 text-slate-500 mx-auto mb-4" />
                <h3 className="text-md font-bold text-slate-200 mb-1">No Bookmarked Stories</h3>
                <p className="text-sm text-slate-500">Stories you bookmark while reading will show up here for easy access.</p>
              </>
            ) : (
              <>
                <BookOpen className="w-10 h-10 text-slate-500 mx-auto mb-4" />
                <h3 className="text-md font-bold text-slate-200 mb-1">No Stories Found</h3>
                <p className="text-sm text-slate-500">There are no published stories matching your current browse options.</p>
              </>
            )}
          </div>
        )}
