      ...
      <div className="mt-6">
        {activeTab === 'stories' && (
          stories.length > 0 ? (
            ...
            <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-16 text-center max-w-lg mx-auto">
              <BookOpen className="w-10 h-10 text-slate-500 mx-auto mb-4" />
              <h3 className="text-md font-bold text-slate-200 mb-1">No stories yet</h3>
              <p className="text-sm text-slate-500 mb-6">You are not the author or contributor of any story drafts yet.</p>
              <Link
                to="/story/create"
        ...
        {activeTab === 'invitations' && (
          invitations.length > 0 ? (
            ...
            <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-16 text-center max-w-lg mx-auto">
              <Mail className="w-10 h-10 text-slate-500 mx-auto mb-4" />
              <h3 className="text-md font-bold text-slate-200 mb-1">Clean Inbox</h3>
              <p className="text-sm text-slate-500">You haven't received any collaboration invites from other storytellers.</p>
            </div>
          )
        )}
        ...
        {activeTab === 'contributions' && (
          contributions.length > 0 ? (
            ...
            <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-16 text-center max-w-lg mx-auto">
              <Feather className="w-10 h-10 text-slate-500 mx-auto mb-4" />
              <h3 className="text-md font-bold text-slate-200 mb-1">No drafts sent</h3>
              <p className="text-sm text-slate-500">You haven't drafted sections for any collaborative stories yet.</p>
            </div>
          )
        )}
        ...
        {activeTab === 'analytics' && (
          analyticsLoading ? (
            ...
            <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-16 text-center max-w-lg mx-auto">
              <span className="text-sm text-slate-500">Failed to render dashboard statistics.</span>
            </div>
          )
        )}
